...
//    public final Context mContext;
    ...
    public MyTaskRecyclerViewAdapter2(List<Task> items, TaskFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
//        mContext = context;
    }
...
//    }
    ...
    @Override
    public MyTaskRecyclerViewAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_task, parent, false);



        return new MyTaskRecyclerViewAdapter2.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(final MyTaskRecyclerViewAdapter2.ViewHolder holder, final int position) {
